  ...
  handleSubmit = () => {
    ...
    form.validateFieldsAndScroll((err, values) => {
      ...
      const params = {
        ...
        saleTimeStart:values && values.saleTimeStart!==undefined ?moment(values.saleTimeStart).format("HH:mm"):null,
        saleTimeEnd:values && values.saleTimeEnd!==undefined ?moment(values.saleTimeEnd).format("HH:mm"):null,
            ...
            <div className={styles.reductionTableListForm}>
              <Form>
                  ...
                  <Col span={24}>
                    ...
                    >
                      {getFieldDecorator('courtId',{
                        ...
                        <Fragment>
                          <Checkbox.Group disabled style={{display:'inline'}} value={stockList && stockList.machineTypeList} onChange={this.onCheckMachineChange}>
                            {
                  ...
                  <Col span={24}>
                    ...
                    >
                      {getFieldDecorator('courtId',{
                        ...
                        <Fragment>
                          <Checkbox.Group disabled style={{display:'inline'}} value={this.state.placeListAll} onChange={this.onCheckPlaceChange}>
                            {
                  ...
                  <Col span={8}>
                    ...
                    >
                      {getFieldDecorator('totalNum',{
                        ...
                        <Input disabled onChange={this.handlePeople}/>
                      )}
                    </FormItem>
                  </Col>
                  {
                ...
                >
                  ...
                  })(<RangePicker disabled style={{width:'100%'}} disabledDate={this.disabledDate} />)}
                </FormItem>
                <FormItem
                  {...formItemLayout}
                ...
                <FormItem label='适用日期类型'>
                  {getFieldDecorator('applyDateType',{
                    ...
                    <Fragment>
                      <Checkbox disabled value={0} onChange={this.onCheckAllChange} checked={this.state.checkAll}>全部</Checkbox>
                      <Checkbox.Group disabled value={this.state.checkedList} onChange={this.onCheckBoxChange} style={{display:'inline'}}>
                        {
                ...
                >
                  ...
                  })(<InputNumber disabled precision={2}  max={999.99}  style={{ width:"100%" }}/>)}
                </FormItem>
                <FormItem
                  label='初始库存'
                >
              ...
              <div>
                <Row gutter={24} style={{marginBottom:'24px',display:'flex'}}>
                  ...
                  <Col span={20}>
                    <ReactQuill value={this.state.value1} onChange={this.handleChange} readOnly style={{background:"#f5f5f5"}} />
                  </Col>
                </Row>
                <Row gutter={24} style={{marginBottom:'24px',display:'flex'}}>
                  ...
                  <Col span={20}>
                    <ReactQuill value={this.state.value2} onChange={this.handleChange2} readOnly style={{background:"#f5f5f5"}} />
                  </Col>
                </Row>
              </div>
            </div>
