...
class PersonalCenter extends Component {
  action = {
    ...
    felechCloseVenue:'venue/felechclosevenue',
    CloseVenueEdit:'venue/closevenueedit',
    CloseVenueDelete:'venue/closevenuedelete',
    CloseVenueSave:'venue/closevenuesave',
  };
  ...
  state = {
    ...
    beforeCloseType:null,// 上个页面传过来的closeType:1,场馆闭馆，2，场地闭馆
  ...
  componentDidMount() {
    ...
    if (location && location.search) {
      ...
      this.setState({
        beforeId:query.id,
        beforeCloseType:query.closeType,
      });
      const param={
        id:query.id,
      };
      if (query.closeType===1){
        dispatch({
          type: this.action.felechCloseVenue,
          payload: param,
        }).then(() =>{
          const {venue:{felechCloseVenueResult}}=this.props;
  ...
  handleCloseInfoDelete =(record) =>{
    ...
    if (record.id!==undefined){
      ...
      dispatch({
        ...
        const {venue:{CloseVenueDeleteResult}}=this.props;
    ...
    validateFieldsAndScroll((error, values) => {
      ...
      if (!error) {
        ...
        dispatch({
          ...
          const {venue:{CloseVenueEditResult}}=this.props;
  ...
  handleAddRow = () => {
    const { dataSource } = this.state;
    // const { reductionDictionary:{dictList} } = this.props;
  ...
  disabledStartDate = (startValue) => {
    ...
    return startValue.valueOf() < nowStartValueString.valueOf() || endValue && startValue.valueOf() > endValue.valueOf();
  };
  ...
  handleButtonSubmit =()=>{
    ...
    dispatch({
      ...
      const {venue:{CloseVenueSaveResult}}=this.props;
  ...
  render() {
    const { startValue, endValue, endOpen ,dataSource,modalReaord} = this.state;
    const { form, loading ,venue:{felechCloseVenueResult}} = this.props;
    ...
    return (
      <Card>
              ...
              <Col span={24}>
                ...
                >
                  {form.getFieldDecorator('closeStart', {
                    ...
                    initialValue:moment(`${modalReaord.businessTimeStart}`,"YYYY-MM-DD HH:mm:ss")
                  })(
                    <DatePicker
              ...
              <Col span={24}>
                ...
                >
                  {form.getFieldDecorator('closeEnd', {
                    initialValue:moment(`${modalReaord.businessTimeEnd}`,"YYYY-MM-DD HH:mm:ss")
                  })(
                    <DatePicker
                      style={{marginRight:10}}
        ...
        <div align="center" style={{width:"100%",height: 50,borderBottomWidth:1,borderBottomColor:"#1890ff"}}>
